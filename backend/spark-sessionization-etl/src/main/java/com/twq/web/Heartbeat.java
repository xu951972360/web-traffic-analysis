...
public class Heartbeat extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.twq.web.Heartbeat.Builder newBuilder() {
    return new com.twq.web.Heartbeat.Builder();
  }
  
  /** Creates a new Heartbeat RecordBuilder by copying an existing Builder */
  public static com.twq.web.Heartbeat.Builder newBuilder(com.twq.web.Heartbeat.Builder other) {
    return new com.twq.web.Heartbeat.Builder(other);
  }
  
  /** Creates a new Heartbeat RecordBuilder by copying an existing Heartbeat instance */
  public static com.twq.web.Heartbeat.Builder newBuilder(com.twq.web.Heartbeat other) {
    return new com.twq.web.Heartbeat.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Heartbeat>
    ...
    private Builder() {
      super(com.twq.web.Heartbeat.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.twq.web.Heartbeat.Builder other) {
      super(other);
    ...
    private Builder(com.twq.web.Heartbeat other) {
            super(com.twq.web.Heartbeat.SCHEMA$);
      if (isValidValue(fields()[0], other.tracker_version)) {
        this.tracker_version = data().deepCopy(fields()[0].schema(), other.tracker_version);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'tracker_version' field */
    public com.twq.web.Heartbeat.Builder setTrackerVersion(java.lang.CharSequence value) {
    ...
    public com.twq.web.Heartbeat.Builder clearTrackerVersion() {
    ...
    /** Sets the value of the 'profile_id' field */
    public com.twq.web.Heartbeat.Builder setProfileId(int value) {
    ...
    public com.twq.web.Heartbeat.Builder clearProfileId() {
    ...
    /** Sets the value of the 'user_id' field */
    public com.twq.web.Heartbeat.Builder setUserId(java.lang.CharSequence value) {
    ...
    public com.twq.web.Heartbeat.Builder clearUserId() {
      user_id = null;
    ...
    /** Sets the value of the 'server_session_id' field */
    public com.twq.web.Heartbeat.Builder setServerSessionId(long value) {
    ...
    public com.twq.web.Heartbeat.Builder clearServerSessionId() {
    ...
    /** Sets the value of the 'server_time' field */
    public com.twq.web.Heartbeat.Builder setServerTime(java.lang.CharSequence value) {
    ...
    public com.twq.web.Heartbeat.Builder clearServerTime() {
      server_time = null;
    ...
    /** Sets the value of the 'loading_duration' field */
    public com.twq.web.Heartbeat.Builder setLoadingDuration(int value) {
    ...
    public com.twq.web.Heartbeat.Builder clearLoadingDuration() {
    ...
    /** Sets the value of the 'page_view_id' field */
    public com.twq.web.Heartbeat.Builder setPageViewId(java.lang.CharSequence value) {
    ...
    public com.twq.web.Heartbeat.Builder clearPageViewId() {
      page_view_id = null;
