...
import com.xu.parser.dataobject.{BaseDataObject, HeartbeatDataObject, McDataObject, PvDataObject}
...
object AvroRecordBuilder {
  //所有实体的类名
  val SESSION:String = classOf[Session].getSimpleName
...
trait AvroRecordBuilder {
  ...
  import com.xu.parser.utils.ParserUtils._
